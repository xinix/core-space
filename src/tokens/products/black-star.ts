...
const tokens: TokenType[] = [
    ...
    {
        product: 'black-star',
        slug: 'machine-pistol-enhanced',
        name: 'Machine pistol enhanced',
        color: 'blue',
        size: 'sm',
        short: 3,
    ...
    },
    {
        ...
        size: 'sm',
        armour: 1,
        icons: ['rare', 'effortless', 'scatter', 'flip'],
        sell: 21,
    },
    {
        product: 'black-star',
        slug: 'quells-fury-chemical',
